...
; début de la configuration de l'ADC
    MOVLB 0x0F; adresse de  ADPCH est F5Fh  bank F 
    MOVLW b'00000101' ; potentiomètre sur ANA5 donc ADCPH = 000101
    MOVWF ADPCH, 1 ; channel ADC
    MOVLW b'00000000' ; 
    MOVWF ADREF, 1 ; configuration apagnan
    MOVLW b'00001111' ; bit 5-0 001111 =  FOSC/32 (fosc = 64mhz)
